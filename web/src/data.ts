...
export const loads: LoadGroup[] = [
  { title: 'Barbell compounds — Freedom Rack', rows: [
    { name: 'Bench Press',       trains: 'Chest',          start: '25 kg / 55 lb', target: '50 kg / 110 lb', ex: 'bench-press' },
    { name: 'Squat',             trains: 'Quads / glutes', start: '30 kg / 66 lb', target: '65 kg / 143 lb', ex: 'squat' },
    { name: 'Barbell Overhead Press', trains: 'Shoulders', start: '20 kg / 44 lb (bar)', target: '32.5 kg / 72 lb', ex: 'overhead-press' },
    { name: 'Barbell Row',       trains: 'Back',           start: '25 kg / 55 lb', target: '50 kg / 110 lb', ex: 'barbell-row' },
  ...
  { title: 'Machine & cable accessories', rows: [
    { name: 'Overhead Press', trains: 'Shoulders', start: '15 kg / 33 lb', target: '32.5 kg / 72 lb', ex: 'machine-overhead-press' },
    { name: 'Lat Pulldown',  trains: 'Back',       start: '25 kg / 55 lb',  target: '50 kg / 110 lb',  ex: 'lat-pulldown' },
    { name: 'Seated Row',    trains: 'Back',       start: '25 kg / 55 lb',  target: '50 kg / 110 lb',  ex: 'seated-row' },
    { name: 'Leg Press',     trains: 'Quads',      start: '55 kg / 120 lb', target: '120 kg / 265 lb', ex: 'leg-press' },
    { name: 'Leg Extension', trains: 'Quads',      start: '25 kg / 55 lb',  target: '50 kg / 110 lb',  ex: 'leg-extension' },
    { name: 'Leg Curl',      trains: 'Hamstrings', start: '20 kg / 44 lb',  target: '40 kg / 88 lb',   ex: 'leg-curl' },
    { name: 'Calf Raise',    trains: 'Calves',     start: '30 kg / 66 lb',  target: '65 kg / 143 lb',  ex: 'calf-raise' },
    { name: 'Incline DB Press', trains: 'Upper chest · per DB', start: '7 kg / 15 lb', target: '15 kg / 33 lb', ex: 'incline-db-press' },
    { name: 'Cable Lateral', trains: 'Side delts · per arm', start: '4 kg / 9 lb', target: '8 kg / 18 lb', ex: 'lateral-raise', star: true },
    { name: 'Face Pull',     trains: 'Rear delts', start: '12 kg / 26 lb',  target: '22 kg / 48 lb',   ex: 'face-pull', star: true },
    { name: 'Curl',          trains: 'Biceps · cable/DB', start: '8 kg / 18 lb', target: '14 kg / 31 lb', ex: ['incline-curl', 'hammer-curl'] },
    { name: 'Rope Pushdown', trains: 'Triceps',    start: '12 kg / 26 lb',  target: '26 kg / 57 lb',   ex: 'triceps-pushdown' },
    { name: 'Overhead Triceps Ext.', trains: 'Triceps · long head', start: '8 kg / 18 lb', target: '18 kg / 40 lb', ex: 'overhead-triceps' },
  ]},
]
