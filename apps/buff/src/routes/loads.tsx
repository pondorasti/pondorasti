    ...
    <>
      ...
      <Pad>
        ...
        <ul className="mt-[18px] max-w-[640px] list-disc space-y-1.5 pl-5 text-[13.5px] text-muted">
          <li>
            <b className="text-txt">Current</b> = your latest logged working weight, synced from
            Hevy.
          </li>
          <li>
            <b className="text-txt">Targets</b> = a realistic 3-month climb for your goal body (
            <b className="text-txt">60 kg / 132 lb at 178 cm</b>) on your machines — the Technogym
            stacks top out around 72 kg / 160 lb.
          </li>
          <li>
