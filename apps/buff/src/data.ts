...
export const equipment = {
  "freedom-rack": {
    name: "Freedom Rack",
    br: "Nautilus · Smith/half-rack, Olympic bar + plates, adjustable bench",
    photo: "/photos/img-7605.jpeg"
  },
  "tg-press": {
    name: "Chest / Overhead Press",
    br: "Technogym · dual-function machine",
    photo: "/photos/img-7589.jpeg"
  },
  "tg-legpress": {
    name: "Leg Press / Calf",
    br: "Technogym · dual-function machine",
    photo: "/photos/img-7588.jpeg"
  },
  "tg-legext": {
    name: "Leg Extension / Curl",
    br: "Technogym · dual-function machine",
    photo: "/photos/img-7592.jpeg"
  },
  "tg-pulls": {
    name: "High / Low Pull",
    br: "Technogym · pulldown + seated row",
    photo: "/photos/img-7603.jpeg"
  },
  "nautilus-ft": {
    name: "Functional Trainer",
    br: "Nautilus Instinct · dual cable towers",
    photo: "/photos/img-7583.jpeg"
  },
  "total-gym": {
    name: "Glideboard",
    br: "Incline rail bodyweight trainer",
    photo: "/photos/img-7587.jpeg"
  },
  "back-ext": { name: "Back-extension Bench", br: "45° frame", photo: "/photos/img-7585.jpeg" },
  treadmill: { name: "Treadmill", br: "Star Trac", photo: "/photos/img-7594.jpeg" },
  "stair-climber": {
    name: "Stair Climber",
    br: "StairMaster Gauntlet",
    photo: "/photos/img-7596.jpeg"
  },
  rower: { name: "Rower", br: "Rail / magnetic resistance", photo: "/photos/img-7595.jpeg" },
  "fan-rower": {
    name: "Fan Rower",
    br: "Air resistance (Assault-style)",
    photo: "/photos/img-7595.jpeg"
  },
  "dip-tower": {
    name: "Dip / Knee-raise Tower",
    br: "FUEL · captain’s chair — dips, vertical knee raises",
    photo: "/photos/img-7586.jpeg"
  },
  gymrax: {
    name: "Free-weight Rig",
    br: "Gym Rax · hex DBs, spin-lock DBs, kettlebell, wall/med balls (8 lb / 3.6 kg), 55 cm ball, rings, foam rollers, step, bands",
    photo: "/photos/img-7604.jpeg"
  }
} as const
...
export const equipmentGroups: { title: string; ids: EquipmentId[] }[] = [
  {
    title: "Strength — Rack & selectorized machines",
    ids: ["freedom-rack", "tg-press", "tg-legpress", "tg-legext", "tg-pulls"]
  },
  {
    title: "Functional / cable & bodyweight",
    ids: ["nautilus-ft", "total-gym", "back-ext", "dip-tower"]
  },
...
export const exercises = {
  "bench-press": {
    ...
    gif: "/anim/bench-press.gif"
  },
  "incline-db-press": {
    name: "Incline DB Press",
    primary: "Upper chest",
    secondary: ["Shoulders"],
    gif: "/anim/incline-db-press.gif"
  },
  "overhead-press": {
    name: "Barbell Overhead Press",
    primary: "Delts",
    secondary: ["Triceps"],
    gif: "/anim/overhead-press.gif"
  },
  "machine-overhead-press": {
    name: "Overhead Press",
    primary: "Delts",
    secondary: ["Triceps"],
    gif: "/anim/machine-overhead-press.gif"
  },
  "lateral-raise": {
    name: "Cable Lateral Raise",
    primary: "Side delts",
    secondary: [],
    gif: "/anim/lateral-raise.gif"
  },
  "triceps-pushdown": {
    name: "Rope Triceps Pushdown",
    primary: "Triceps",
    secondary: [],
    gif: "/anim/triceps-pushdown.gif"
  },
  "overhead-triceps": {
    name: "Overhead Cable Triceps Ext.",
    primary: "Triceps",
    secondary: ["long head"],
    gif: "/anim/overhead-triceps.gif"
  },
  "barbell-row": {
    name: "Barbell Row",
    primary: "Upper back",
    secondary: ["Biceps"],
    gif: "/anim/barbell-row.gif"
  },
  "lat-pulldown": {
    name: "Lat Pulldown",
    primary: "Lats",
    secondary: ["Biceps"],
    gif: "/anim/lat-pulldown.gif"
  },
  "seated-row": {
    name: "Seated Row",
    primary: "Mid back",
    secondary: ["Biceps"],
    gif: "/anim/seated-row.gif"
  },
  "face-pull": {
    name: "Face Pull",
    primary: "Rear delts",
    secondary: ["Traps"],
    gif: "/anim/face-pull.gif"
  },
  "incline-curl": {
    name: "Incline DB Curl",
    primary: "Biceps",
    secondary: [],
    gif: "/anim/incline-curl.gif"
  },
  "hammer-curl": {
    name: "Hammer / Rope Curl",
    primary: "Biceps",
    secondary: ["Forearms"],
    gif: "/anim/hammer-curl.gif"
  },
  squat: {
    name: "Barbell Squat",
    primary: "Quads",
  ...
  "leg-press": {
    ...
    primary: "Quads",
    secondary: ["Glutes"],
    gif: "/anim/leg-press.gif"
  },
  "leg-extension": {
    name: "Leg Extension",
    primary: "Quads",
    secondary: [],
    gif: "/anim/leg-extension.gif"
  },
...
export const loads: LoadGroup[] = [
  {
    title: "Barbell compounds — Freedom Rack",
    rows: [
      {
        name: "Bench Press",
        trains: "Chest",
        current: "33.5 kg / 74 lb",
        target: "45 kg / 100 lb",
        ex: "bench-press"
      },
      {
  ...
  {
    title: "Machine & cable accessories",
    rows: [
      {
        name: "Overhead Press",
        trains: "Shoulders",
      ...
      {
        name: "Curl",
        trains: "Biceps · cable/DB",
        current: "7 kg / 15 lb",
        target: "12 kg / 26 lb",
        ex: ["incline-curl", "hammer-curl"]
      },
      {
        name: "Rope Pushdown",
        trains: "Triceps",
...
/* ---- Derived relations ---- */
export const getDayBySlug = (slug: string): Day | undefined => days.find((d) => d.slug === slug)
...
export const itemPrimary = (i: DayItem): string =>
  i.primary ?? (i.ex ? exercises[i.ex].primary : "")
