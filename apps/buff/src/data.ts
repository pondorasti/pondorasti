...
export const loads: LoadGroup[] = [
  { title: 'Barbell compounds — Freedom Rack', rows: [
    { name: 'Bench Press',       trains: 'Chest',          current: '33.5 kg / 74 lb', target: '45 kg / 100 lb', ex: 'bench-press' },
    { name: 'Squat',             trains: 'Quads / glutes', current: '29 kg / 64 lb', target: '65 kg / 143 lb', ex: 'squat' },
    { name: 'Barbell Overhead Press', trains: 'Shoulders', current: '20 kg / 44 lb (bar)', target: '30 kg / 66 lb', ex: 'overhead-press' },
    { name: 'Barbell Row',       trains: 'Back',           current: '24.5 kg / 54 lb', target: '45 kg / 100 lb', ex: 'barbell-row' },
    { name: 'Romanian Deadlift', trains: 'Hams / glutes',  current: '32 kg / 70 lb', target: '65 kg / 143 lb', ex: 'rdl' },
  ]},
  { title: 'Machine & cable accessories', rows: [
    ...
    { name: 'Curl',          trains: 'Biceps · cable/DB', current: '7 kg / 15 lb', target: '12 kg / 26 lb', ex: ['incline-curl', 'hammer-curl'] },
    { name: 'Rope Pushdown', trains: 'Triceps',    current: '9 kg / 20 lb',  target: '18 kg / 40 lb',   ex: 'triceps-pushdown' },
    { name: 'Overhead Triceps Ext.', trains: 'Triceps · long head', current: '7 kg / 15 lb', target: '14 kg / 30 lb', ex: 'overhead-triceps' },
  ]},
]
